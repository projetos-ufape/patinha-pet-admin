    ...
    <form action="#" method="POST">
        ...
        <div class="flex mb-6">
            <div style="display: inline-block; width: 49%;">
                <input type="text" name="cellphone" id="cellphone" class="w-full px-4 py-2 border border-gray-300 rounded-md" placeholder="Celular" required>
            </div>
        ...
        <div class="flex justify-between">
            <a href="{{ route('customer.index') }}" class="cancel-button">Cancelar</a>
