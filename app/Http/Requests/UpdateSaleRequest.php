...
class UpdateSaleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sale_items' => 'sometimes|array|min:1',
            'sale_items.*.id' => 'sometimes|exists:sale_items,id',
            'sale_items.*.price' => 'required_with:sale_items.*.id|numeric|min:0',
            'sale_items.*.type' => 'required_with:sale_items.*.id|in:product,appointment',
